...
func BenchmarkToStructE_flat_fromStringMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchFlat](benchFlatStringMap)
	}
}
...
func BenchmarkToStructE_flat_fromStruct(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchFlat](benchFlatSrc)
	}
}
...
func BenchmarkToStructE_flat_strict(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchFlat](benchFlatMap, cast.Op{Flag: cast.STRICT, Val: true})
	}
}
...
func BenchmarkToStructE_flat_fromStruct_strict(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchFlat](benchFlatSrc, cast.Op{Flag: cast.STRICT, Val: true})
	}
}
...
func BenchmarkToStructE_nested_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchPerson](benchPersonMap)
	}
}
...
func BenchmarkToStructE_nestedWithSlice_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchOrder](benchOrderMap)
	}
}
...
func BenchmarkToStructE_deep_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchDeep](benchDeepMap)
	}
}
...
func BenchmarkToStructE_richTypes_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchRich](benchRichMap)
	}
}
...
func BenchmarkToStructE_large_fromMap(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchLarge](benchLargeMap)
	}
}
...
func BenchmarkToStructE_embedded_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchEmbedded](benchEmbeddedMap)
	}
}
...
func BenchmarkToStructE_embeddedPtr_fromMap(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchEmbeddedPtr](benchEmbeddedPtrMap)
	}
}
...
func BenchmarkToStructE_sliceOfStructs_3(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = cast.ToE[benchCart](benchCartMap)
	}
}
